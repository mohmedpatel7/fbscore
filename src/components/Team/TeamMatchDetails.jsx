        ...
        <div id="tab2" className="tab-pane fade">
          <div className="row">
            <div className="col-12 mt-3 mb-4">
              <h4 className="text-center" style={{ color: "#50C878", fontWeight: "700" }}>
                ...
                <div className="col-md-6">
                  <div className="card h-100 shadow-sm border-0" 
                    ...
                    <div className="card-header text-white p-3" 
                         style={{ 
                           background: "linear-gradient(135deg, #50C878 0%, #3a9c5a 100%)",
                           borderBottom: "none" 
                         }}>
                      <div className="d-flex align-items-center">
                        ...
                        <div className="ms-3">
                          <h5 className="mb-0 fw-bold">{matchDetails.teams.teamA.name}</h5>
                    ...
                    <div className="card-body p-0">
                      <div className="list-group list-group-flush">
                        {matchDetails.teams.teamA.players.map((player, index) => (
                          <div
                            key={player.id}
                            ...
                            onClick={() => playerProfileClick && playerProfileClick(player.id)}
                          >
                            <div className="d-flex align-items-center">
                              <div className="position-relative">
                                <img
                              ...
                              <div className="ms-3 flex-grow-1">
                                <h6 className="mb-0 fw-semibold">{player.name}</h6>
                  ...
                  <div className="card h-100 shadow-sm border-0" 
                    ...
                    <div className="card-header text-white p-3" 
                      ...
                      <div className="d-flex align-items-center">
                        ...
                        <div className="ms-3">
                          <h5 className="mb-0 fw-bold">{matchDetails.teams.teamB.name}</h5>
                    ...
                    <div className="card-body p-0">
                      <div className="list-group list-group-flush">
                        {matchDetails.teams.teamB.players.map((player, index) => (
                          <div
                            key={player.id}
                            className="list-group-item list-group-item-action border-0 py-3 px-4"
                            style={{
